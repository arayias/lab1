...
```{r setup-tibble}
usernames <- c("wilsonamy", "arayias", "username 2", "username 3", "username 4") #Extend if necessary
nums <- c(18, 3, NA, NA, NA) #Extend if necessary
colours <- c("powderblue", "sienna", "colour 2", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "football", "Hobby 2", "Hobby 3", "Hobby 4") #Extend if necessary
